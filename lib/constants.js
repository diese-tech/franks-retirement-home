...
export const MATCH_STATUSES = ['scheduled', 'live', 'completed', 'postponed'];

export const MATCH_FORMATS = ['BO1', 'BO3', 'BO5'];

export const SEASON_STATUSES = ['upcoming', 'active', 'completed'];

export const TEAMS = ['A', 'B'];

// Role badge colors (tailwind classes)
export const ROLE_COLORS = {
  Solo:    'bg-orange-500/15 text-orange-700 dark:text-orange-400',
  Jungle:  'bg-green-500/15 text-green-800 dark:text-green-400',
  Mid:     'bg-purple-500/15 text-purple-700 dark:text-purple-400',
  Support: 'bg-blue-500/15 text-blue-700 dark:text-blue-400',
  Carry:   'bg-red-500/15 text-red-700 dark:text-red-400',
  Fill:    'bg-gray-500/15 text-gray-700 dark:text-gray-400',
};
